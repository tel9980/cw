...
def sample_order(db_manager):
    """创建示例订单"""
    customer = Customer(name="测试客户", contact="李四", phone="13900139000")
...
class TestOutsourcedProcessingManager:
    ...
    def test_list_processing_by_order(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试按订单查询委外加工记录"""
        # 创建多个委外加工记录
    ...
    def test_list_processing_by_supplier(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试按供应商查询委外加工记录"""
        # 创建委外加工记录
        ...
        # 查询供应商的委外加工记录
        processing_list = processing_manager.list_processing_by_supplier(
            sample_supplier.id
        )
    ...
    def test_allocate_payment_to_multiple(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试将付款分配到多个委外加工记录"""
        # 创建多个委外加工记录
        ...
        # 分配付款
        allocations = {p1.id: Decimal("100"), p2.id: Decimal("75")}
    ...
    def test_get_supplier_unpaid_processing(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试获取供应商的未付清委外加工记录"""
        # 创建委外加工记录
    ...
    def test_get_supplier_total_unpaid(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试获取供应商的未付总额"""
        # 创建委外加工记录
    ...
    def test_get_statistics_by_supplier(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试按供应商统计委外加工情况"""
        # 创建委外加工记录
    ...
    def test_get_statistics_by_process_type(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试按工序类型统计委外加工情况"""
        # 创建委外加工记录
    ...
    def test_delete_processing_with_payment_fails(
        self, processing_manager, sample_order, sample_supplier
    ):
        """测试删除已付款的委外加工记录应该失败"""
        # 创建委外加工记录并付款
