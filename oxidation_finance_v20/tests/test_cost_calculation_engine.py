...
from business.cost_calculation_engine import CostCalculationEngine
...
from models.business_models import PricingUnit, ProcessType
...
class TestCostCalculationEngine:
    ...
    def test_calculate_outsourcing_cost_single(self, db_manager, order_manager, outsourced_manager):
        """测试委外加工费计算 - 单个委外"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_calculate_outsourcing_cost_multiple(self, db_manager, order_manager, outsourced_manager):
        """测试委外加工费计算 - 多个委外"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_calculate_total_processing_fee_no_outsourcing(self, db_manager, order_manager):
        """测试总加工费计算 - 无委外"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_calculate_total_processing_fee_with_outsourcing(self, db_manager, order_manager, outsourced_manager):
        """测试总加工费计算 - 含委外"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_calculate_order_profit(self, db_manager, order_manager, outsourced_manager):
        """测试订单利润计算"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_calculate_order_profit_margin(self, db_manager, order_manager, outsourced_manager):
        """测试订单利润率计算"""
        engine = CostCalculationEngine(db_manager)
    ...
    def test_validate_order_costs_valid(self, db_manager, order_manager, outsourced_manager):
        """测试订单费用验证 - 有效"""
        engine = CostCalculationEngine(db_manager)
